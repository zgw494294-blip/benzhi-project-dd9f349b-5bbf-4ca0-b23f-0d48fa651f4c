...
// isFiniteTemperature reports whether the given temperature is a finite number.
// NaN, +Inf and -Inf are rejected because they break range checks (any comparison
// involving them yields false) and would otherwise let non-finite inputs slip
// through both box creation and handoff temperature validation.
